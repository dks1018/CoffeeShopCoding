...
# mobydick = 'C:\\Users\\Darius\\Desktop\\BlackhatChallenge\\mobydick.txt'
mobytext = open("C:/Users/Darius/Desktop/Projects/helloworld/Udel/AppliedCrypto/test1.txt",encoding="utf8")

onlyletters = filter(lambda x: x.isalpha(), mobytext)
onlyletters = str(onlyletters)
